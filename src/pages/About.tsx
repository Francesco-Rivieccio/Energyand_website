...
const team = [
  ...
  {
    name: 'Francesco Zelano',
    role: 'CFO & Head of Financial Advisory',
    bio: '15 years of experience in global investment banking with expertise in energy markets, capital structuring, and infrastructure financing. Leads the company\'s investor-focused advisory services.',
    email: 'f.zelano@energyand.com',
    linkedin: 'https://linkedin.com',
    initials: 'FZ',
  },
  {
    ...
    bio: 'Specialized in electrical station installation across Italy. Experienced in commissioning, site operations and grid integration activities.',
  ...
  },
  {
    name: 'Michele Zelano',
    role: 'Assistant Engineer',
    bio: 'Recently joined the company with 10 years in the renewable energy sector. Focused on on-site implementation and field coordination.',
    email: 'm.zelano@energyand.com',
    linkedin: 'https://linkedin.com',
    initials: 'MZ',
  },
  {
    name: 'Francesco Rivieccio',
    role: 'Simulation & Modelling Engineer',
    bio: 'Develops bespoke profitability assessment tools for renewable projects, particularly wind farms, using predictive modelling of future wind patterns and power generation.',
    email: 'f.rivieccio@energyand.com',
    linkedin: 'https://linkedin.com',
    initials: 'FR',
  },
];
